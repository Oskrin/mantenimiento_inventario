                                                ...
                                                <row>
                                                    ...
                                                    <div class="span6">
                                                        <div class="control-group">											
                                                            ...
                                                            <div class="controls">
                                                                <input type="text" name="ruc_ci"  id="ruc_ci" placeholder="Ingrese Identificación" required class="span4" pattern="[0-9]{10,10}" maxlength="10" data-original-title data-toggle="tooltip" />
