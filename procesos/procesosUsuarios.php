...
if ($_POST['oper'] == "add") {
    ...
    pg_query("insert into usuario values('$cont','$_POST[nombre_usuario]','$_POST[apellido_usuario]','$_POST[ci_usuario]','$_POST[telefono_usuario]','$_POST[celular_usuario]','$_POST[cargo_usuario]','$_POST[password_usuario]','$_POST[email_usuario]','$_POST[direccion_usuario]','$_POST[user]','Activo')");
} else {
    if ($_POST['oper'] == "edit") {
